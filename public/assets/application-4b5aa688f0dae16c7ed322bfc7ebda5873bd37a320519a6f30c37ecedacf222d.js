...
(function() {
  ...
  loadGrid = function() {
    var $comp, $masnon, SocialList, path, runPackery, waypointPostGrid;
    $masnon = void 0;
    runPackery = function() {
      SocialList();
      $masnon = $('.grid').isotope({
    ...
    $comp = $('.all-posts-grid');
    path = void 0;
    $comp.find('a').on('click', function() {
      path = window.location.pathname;
    });
    $('body').on('click', '#close-modal', function() {
      window.history.replaceState({}, document.title, path);
    });
    $('body').on('gridLoaded', function(data, cb) {
      var $elems;
      $elems = $('.temp-to');
      setTimeout((function() {
        $('.temp-to').children().each(function(idx, val) {
          $(this).detach();
    ...
    waypointPostGrid = new Waypoint({
      ...
      handler: function(direction) {
        ...
        if (direction === 'down') {
          ...
          i = 0.4;
          $('.all-posts-grid .item').each(function() {
            var item;
            item = $(this);
